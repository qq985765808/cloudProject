...
public class SeckillingActivity implements Serializable {
    ...
    public String toString() {
        return "SeckillingActivity{" +
                "seckillingActivityId=" + seckillingActivityId +
                ", seckillingActivityName='" + seckillingActivityName + '\'' +
                ", productsId=" + productsId +
                ", seckillingActivityBeginTime=" + seckillingActivityBeginTime +
                ", seckillingActivityEndTime=" + seckillingActivityEndTime +
                ", seckillingActivityProductsNum=" + seckillingActivityProductsNum +
                ", seckillingActivityIntroduction='" + seckillingActivityIntroduction + '\'' +
                '}';
    }
}
